...
python PPSTM/rel_scan.py --pos # AFM scan with CO tip, positions of PP saved in Q*.**K*.**/PPpos_?.npy
python PPSTM/plot_AFM_res.py --pos --df --save_df  # save figures of PP positions; figures of df and save df into Q*.**K*.**/Amp*.**/df.pny file 
